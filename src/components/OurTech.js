        ...
        <div>
            ...
            <div  className = "row pad">
                <div className = "col-md-6">
                    <iframe style = {{width: "100%", height: "315px"}} src="https://www.youtube.com/embed/ixo0V6rNqi0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div className = "col-md-6">
                ...
                <div className = "row" style = {{marginTop: "40px"}}>
                    ...
                    <div className = "col-md-6" >
                        <img src = {digital} style = {{width: "100%"}} />
                    </div>
                </div>
            </div>
        </div>
