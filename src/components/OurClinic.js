  ...
  return (
    <div>
      ...
      <div className = "pad row">
        ...
        <div style = {{marginTop: "40px"}} className = "col-sm-3">
        ...
        <div className = "col-lg-9" style = {{marginTop: "40px"}}>
          ...
          <p>While she enjoys most aspects of dentistry, Jess has particular interests in orthodontics (<a href = "#">Invisalign/Clear Correct</a> and <a href = "#">fixed braces for children and adults</a>), <a href = "#">cosmetic dentistry</a> and <a href = "">dental sleep medicine</a>. It never ceases to amaze her when tweaking small things in a person’s smile can boost their confidence, or how adjusting the position of the jaw can vastly improve the quality of sleep.</p>
        </div>
      </div>
      <Footer />
    </div>
